...
<template>
    ...
    <div class="service service-shown" style="--dif: 4">
        <img src="/empty-wooden-shelves.jpg" alt="Empty Wooden Shelves" title="Empty Wooden Shelves"
            ...
            <p>Our shelves are handcrafted from the finest wood, using traditional carpentry techniques. Each shelf is a unique work of art that will add beauty and functionality to your home. </p>
        </div>
    </div>
    <div class="service service-shown" style="--dif: 5">
        <img src="/classic-bedroom-hotel-room-with-doubles-bed.jpg" alt="Classic Room with Doubles Bed" title="Classic Room with Doubles Bed"
        draggable="false" />
        <div class="service-body">
            <strong>We do Beds</strong>
            <p>Our beds are made from the highest quality materials and craftsmanship, and we are committed to providing our customers with the best possible experience. </p>
        </div>
    </div>
    <div class="service service-shown" style="--dif: 6">
        ...
        <div class="service-body">
            ...
            <p>We design and build custom cupboards to fit your needs, whether you\'re looking for a new kitchen, bathroom, or bedroom storage solution. We offer a wide variety of cupboard styles and finishes to choose from, so you can find the perfect look for your home. </p>
        </div>
    </div>
</div>
</template>
...
.service {
    ...
    transition: 0.3s cubic-bezier(0.77, 0, 0.175, 1), opacity calc(0.1s * var(--dif)) cubic-bezier(0.1, 0, 0.175, 1) calc(0.1s * var(--dif));
    border-radius: 3px;
}
