...
<template>
    <footer>
        ...
        <div class="created-by"><span>Created By <a href="https://github.com/CHIBX" target="_blank">Chinaemerem Chiebidolu</a></span></div>
    </footer>
</template>
...
<style scoped>
    ...
    .social-links h3 {margin-bottom: 20px;}
    .social-links svg{
        font-size: 24px;
    }
    .base-line{
